...
const content = {
  en: {
    ...
    skills: [
      ...
      { label: 'Quality & Regulatory', tags: ['GMP', 'ISO 13485', 'ISO 14971', 'IEC 60601', 'IEC 62366', 'FMEA', 'Fault Tree Analysis', 'CAPA', 'Six Sigma', 'Lean / Kaizen', 'DOE', 'SPC', 'LCA'] },
  ...
  th: {
    ...
    heroAvail: 'พร้อมทำงานตั้งแต่ สิงหาคม 2569 · เปิดรับโอกาสในไทย สิงคโปร์ และทั่วโลก',
    heroBtn1: 'ดูผลงาน →',
    heroBtn2: 'ติดต่อฉัน',
    stats: [
    ...
    skills: [
      ...
      { label: 'คุณภาพและกฎระเบียบ', tags: ['GMP', 'ISO 13485', 'ISO 14971', 'IEC 60601', 'IEC 62366', 'FMEA', 'Fault Tree Analysis', 'CAPA', 'Six Sigma', 'Lean / Kaizen', 'DOE', 'SPC','LCA'] },
