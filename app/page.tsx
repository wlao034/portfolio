...
const content = {
  en: {
    ...
    languages: [
      ...
      { name: '한국어', level: 'Elementary (completed KEC NZ Introductory 1A; currently King Sejong Institute Level 1B; TOPIK I target December 2026)', fluent: false },
    ],
  ...
  th: {
    ...
    languages: [
      ...
      { name: '한국어', level: 'ระดับต้น (สำเร็จหลักสูตร KEC NZ ระดับเริ่มต้น 1A แล้ว; กำลังเรียนที่ King Sejong Institute ระดับ 1B; ตั้งเป้าสอบ TOPIK I ภายในเดือนธันวาคม 2026)', fluent: false },
    ],
